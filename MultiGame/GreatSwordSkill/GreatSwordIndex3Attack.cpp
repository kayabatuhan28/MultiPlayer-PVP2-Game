...
#include "GreatSwordIndex3Attack.h"

#include "Particles/ParticleSystemComponent.h"

// Sets default values
AGreatSwordIndex3Attack::AGreatSwordIndex3Attack()
{
...
void AGreatSwordIndex3Attack::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AGreatSwordIndex3Attack::Tick(float DeltaTime)
{
